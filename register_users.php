...
<html lang="en">
<head>
    <title>Upload Users - Admin</title>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        .hero-overlay {
            position: absolute;
            inset: 0;
            background: rgba(0, 188, 212, 0.70);
            border-radius: 0 0 28px 28px;
            z-index: 1;
        }
        .hero-content {
        ...
        .image-box img {
            ...
            max-width: 100%;
            border-radius: 11px;
            box-shadow: 0 4px 14px #00bcd410;
        }
...
<body>
    <div class="hero-header">
        ...
        <div class="hero-content">
            <h1>
                <i class="fas fa-file-upload"></i> Upload Users via Excel
            </h1>
            <div class="subtitle">
                Quickly register multiple users by uploading an Excel file.
            </div>
        </div>
    </div>
    <div class="upload-container">
        <h2>📥 Upload Excel to Register Users</h2>
        ...
        <div class="image-box">
            <img src="images/students.png" alt="Users Upload">
        </div>
    </div>
</body>
</html>
